  ...
  render() {
    return (
      <Layout>
        ...
        <p>This website uses the Ethereum network to save dedications to people. To make a dedication to someone, a person sends crypto-currency from their online digital wallet to pay for the processing power it takes to save a dedication to the Ethereum blockchain. This website specifically uses a test network, so no actual money is being used. To try this out for yourself, follow the steps below!</p>
        <h2>How to</h2>
        <List ordered>
          <List.Item>
            ...
            <List.List>
              ...
              <List.Item>When you're done, click the fox icon in the upper right of your browser</List.Item>
              <List.Item>Create an account, then click on the dropdown that says 'MainNet' and change it to 'Rinkeby'</List.Item>
              <List.Item>Find the button to save your address to your clipboard and press it</List.Item>
